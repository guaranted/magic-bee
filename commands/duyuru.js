...
message.delete();
return message.channel.send(new Discord.MessageEmbed().setTitle('<:MegafonPng:708215767211966534> Yeni Duyurunuz Var!').setFooter(message.author.tag + 'tarafından duyuruldu').setDescription(args[0]));
