...
if(!args[0]) return message.channel.send(nn.setColor('RED').setTitle('Bir hata oldu!').setDescription(`Selam açmak istersen **${client.ayarlar.prefix}selam aç** yazmalısın.`))
if(args[0] === 'aç') {
