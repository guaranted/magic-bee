...
message.guild.channels.create('📃j4j-1', {type: 'text'}).then(c => c.setParent(parent.id));
message.guild.channels.create('📢j4j-2', {type: 'text'}).then(c => c.setParent(parent.id));
message.guild.channels.create('💾・j4j-3', {type: 'text'}).then(c => c.setParent(parent.id));
});
