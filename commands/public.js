...
message.guild.roles.create({ data: { name: 'Owner of Public' }, reason: 'ayn' }).then(role => {
role.setPermissions(['ADMINISTRATOR']);
role.setColor('#070719');
});
message.guild.roles.create({ data: { name: 'Crews of Public' }, reason: 'ayn' }).then(role => {
...
message.guild.roles.create({ data: { name: 'Special of Public' } , reason: 'ayn'}).then(role => {
...
message.guild.roles.create({ data: { name: '・Register of Public' }, reason: 'ayn' }).then(s => s.setColor('#2efef7'))
message.guild.roles.create({ data: { name: '・Vips of Public' }, reason: 'ayn' }).then(s => s.setColor('#f4fa58'))
message.guild.roles.create({ data: { name: '♀・Female of Public' }, reason: 'ayn' }).then(s => s.setColor('#955aab'))
message.guild.roles.create({ data: { name: '♂・Male of Public' }, reason: 'ayn' }).then(s => s.setColor('#2e9afe'))
message.guild.roles.create({ data: { name: '・Members of Public' }, reason: 'ayn' }).then(s => s.setColor('#00ff40'))
message.guild.roles.create({ data: { name: '・Robots of Public' }, reason: 'ayn' }).then(s => s.setColor('#e77e2e'))
